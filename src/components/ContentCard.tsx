...
export default function ContentCard(Props:Props) {
  return (
    <Link
      ...
      className="group block h-30 bg-white rounded-xl shadow-sm hover:shadow-lg transition-all duration-300 overflow-hidden border border-gray-200 hover:border-blue-200 relative"
    >
